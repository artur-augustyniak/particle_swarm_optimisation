...
public class SuperConcurrentScalarPSO {
    ...
    private static final List<Callable<Object>> ITERATE_JOBS = new ArrayList<>(ITERATIONS);
    ...
    private static final ExecutorService INNER_EXEC_SERVICE = Executors.newFixedThreadPool(5);

    public static class Iteration implements Callable<Object> {

        @Override
        public Object call() throws Exception {
            INNER_EXEC_SERVICE.invokeAll(SWARM);
            return null;
        }
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int j = 0; j < ITERATIONS; j++) {
            ITERATE_JOBS.add(new Iteration());
        }
        
        long startTime = System.currentTimeMillis();
        
            EXECS_ERVICE.invokeAll(ITERATE_JOBS);
        
        long stopTime = System.currentTimeMillis();
        long elapsedTime = stopTime - startTime;
        System.out.println(elapsedTime);
        EXECS_ERVICE.shutdown();
        INNER_EXEC_SERVICE.shutdown();
        //124
